...
### 주인만 가능한 작업 (일반 선생님 제한)

- **① 명단** 탭 전체 (학생 추가/수정/삭제·엑셀 업로드)
- **② 출결·채점**의 **차시 삭제**
- **④ 안내·숙제**의 **공통 숙제**와 **안내문자 템플릿** 편집
- 하단 **전체 초기화 · 백업 복원 · 예시 데이터**

일반 선생님은 출결·채점 입력, 안내카드 열람/인쇄, 안내문자 복사와
학생별 개별 숙제 입력, 백업 저장(내려받기)만 할 수 있습니다.
